...
sendEphemeral: false,
"externalAdReply": {
                "title": `Whatsapp-BOT\n𝑷𝒖𝒕𝒃𝒐𝒕𝒛. (@nnda.krnwn_) •Instagram photos and Videos`,
                "body": "",
                "previewType": "PHOTO",
...
*Thank you for registering in the 𝑃𝑢𝑡𝑏𝑜𝑡𝑧 Database*
...
*「 𝑃𝑢𝑡𝑏𝑜𝑡𝑧 」*`
         haitod = await getBuffer(`http://hadi-api.herokuapp.com/api/card/verify?nama=${encodeURI(pushname)}&member=${_registered.length}&seri=${serialUser}&pp=${ppimg}&bg=${ppimg}`)
             buttons = [{buttonId: `menu`,buttonText:{displayText: `</️MENU`},type:1}]
              ...
              buttonsMessage = {footerText:'𝑃𝑢𝑡𝑏𝑜𝑡𝑧', imageMessage: imageMsg,
...
if (!isRegistered) return sendButMessage (from, daftar1, daftar2, daftar3, { quoted: fkontak})
       txtt =` ▢ 𝐇𝐢 ${pushname} \n ▢ 𝐆𝐫𝐨𝐮𝐩 𝐂𝐡𝐚𝐭𝐬 : ${groups.length} \n ▢ 𝐏𝐫𝐢𝐯𝐚𝐭𝐞 𝐂𝐡𝐚𝐭𝐬 : ${privat.length}\n ▢ 𝐓𝐨𝐭𝐚𝐥 𝐂𝐡𝐚𝐭𝐬 : ${totalChat.length} \n ▢ 𝐒𝐩𝐞𝐞𝐝 : ${latensie.toFixed(4)} _Second_ \n ▢ 𝐀𝐜𝐭𝐢𝐯𝐞 : ${runtime(process.uptime())} \n ▢ 𝐏𝐥𝐚𝐭𝐟𝐨𝐫𝐦 : ${os.platform()}`
               ...
               buttonsMessage = {
               contentText: `${txtt}`,
               footerText: `𝑃𝑢𝑡𝑏𝑜𝑡𝑧`, imageMessage: imageMsg,
               buttons: buttons,
               headerType: 4
}
prep = await xeon.prepareMessageFromContent(from,{buttonsMessage},{quoted: fkontak})
...
break
case 'h':
reply('he/she is gone bro.. may he/she sakit perut')
break
case 'okeyx':
...
case 'mygithub':
  reply('╭─➤ *𝑃𝑢𝑡𝑏𝑜𝑡𝑧*\n│       ❑  *sᴄʀɪᴘᴛ*\n│❖  ɢɪᴛʜᴜʙ:\n│❖   https://github.com/pepesir/Putbotz\n│❖  𝙄𝙉𝙎𝙏𝘼𝙂𝙍𝘼𝙈:\n│❖   https://www.instagram.com/unluckyputttt/╰────────────────❋ཻུ۪۪⸙\n\n⌕ ❙❘❙❙❘❙❚❙❘❙❙❚❙❘❙❘❙❚❙❘❙❙❚❙❘❙❙❘❙❚❙❘\n             ᴘᴇᴘᴇ sɪʀ\n\n╭◪ *𝐶𝑜𝑑𝑒𝑑 𝑏𝑦 𝑝𝑢𝑡𝑏𝑜𝑡𝑧*\n╰─────────────────❋ཻུ۪۪⸙')
					break;
   case 'ss':
      reply(mess.wait)
